export default function connaitreData() { return [
	{
		...
		impacts: [
			...
			`Je n’ai <strong>pas accès aux services municipaux de Sherbrooke</strong> qui nécessitent une pièce d'identité, comme la bibliothèque ou la piscine.`,
			`On <strong>ne me permet pas de me projeter dans l’avenir</strong> en raison de l'incertitude dans laquelle je vis. Mes aspirations sont restreintes par mon statut d’immigration, ce qui engendre un profond sentiment d’exclusion et de manque d’appartenance à la société où je vis depuis plus de 15 ans.`
		],
	...
	} ,
	{
		...
		presentation: [
			`Cela signifie que j'ai <strong>déposé une demande d’asile</strong> à mon arrivée au Canada, mais celle-ci <strong>a été rejetée</strong>.`,
			`Après le refus de la demande d'asile, <strong>nous pouvons encore rester sur le territoire</strong> en tant que personnes demandeuses d’asile refusées. Cependant, nos droits sont considérablement limités, et nous vivons dans l'angoisse d'être renvoyées à notre pays d'origine, là où nous croyons que nous serions en péril ou en danger de persécution, d'où la raison de notre demande d'asile. Il existe des recours et des démarches pour régulariser notre situation. Cependant, le processus est complexe et long, s'étendant sur plusieurs années, et le résultat demeure incertain, sans aucune garantie.`
		],
		impactIntro: `Mon statut d'immigration est <strong>précaire car ...</strong>`,
		impacts: [
			`On m’a <strong>contraint de quitter mon emploi</strong> et de vivre de l’aide sociale car je n’ai plus un permis de travail valide.`,
			`Je ne peux faire <strong>aucune démarche pour amener mon ou ma conjointe</strong> et enfants au Canada, et je ne peux plus leur envoyer de l’argent, car mes revenus sur l’aide sociale sont insuffisants.`,
			`On m’a informé qu'après le refus de ma demande d'asile, <strong>on va me renvoyer dans mon pays d’origine</strong>. Depuis plusieurs mois, je vis chaque jour dans le stress et la peur constante, ne sachant pas quand je serai forcée de quitter le Canada et de retourner dans mon pays.`,
			`En attendant, je cherche d’autres solutions pour rester ici, parce que j'ai <strong>encore peur des menaces et de la torture</strong> dans mon pays d’origine`
		],
		...
		mytheExplications: [
			...
			`Malheureusement, certaines personnes dont la demande d'asile a été refusée et qui peuvent encore rester sur le territoire ne disposent plus de permis de travail, <strong>malgré leur désir de continuer</strong> à subvenir à leurs propres besoins et ainsi à l’économie du Québec.`,
			`Par exemple, <a href='https://www.ledevoir.com/societe/676806/refugies-dans-la-maison-de-dieu' target='_blank' rel='noreferrer'>la famille Rodriguez Flores</a> a déposé une demande d’asile en 2019 et vivait à Sherbrooke en attendant une décision. Pendant cette période, la famille s’est bien intégrée, a travaillé dans les commerces locaux, et leur fils est allé à l’école. Après plusieurs années d’attente, la réponse reçue fut négative. En raison d'irrégularités dans leur dossier, ils devaient retourner au Mexique, leur pays d’origine, malgré les craintes pour leur vie là-bas. Pendant un an, en tant que demandeurs d’asile déboutés, ils ont vécu dans la peur et l’inquiétude de devoir rentrer.`
		]
	} ,
	{
		...
		presentation: [
			`Cela signifie que j'ai dû <strong>fuir mon foyer pour échapper à la violence de mon conjoint</strong>. L'État canadien m'a accordé un Permis de séjour temporaire pour victimes de violence conjugale. Toutefois, ce permis doit être renouvelé chaque année, sans garantie de prolongation et avec un taux de succès relativement faible.`,
		],
		impactIntro: `Mon statut d'immigration est <strong>précaire car ...</strong>`,
		impacts: [
			`<strong>Je vis dans l’angoisse</strong> quant à la possibilité de renouveler mon Permis de séjour temporaire l’année prochaine. Si on ne m'accorde pas le renouvellement de mon permis annuel, <strong>je devrai quitter le territoire canadien</strong>.`,
			`Je vis dans l’incertitude car je ne peux <strong>pas me projeter</strong> dans l’avenir.`,
			`<strong>Je risque de perdre la garde de mes enfants</strong> au profit de mon mari violent, car après avoir quitté le foyer où je subissais de la violence conjugale, je réside dans un centre d’hébergement pour femmes victimes de violence et je n’ai pas encore trouvé de logement adéquat où je pourrais vivre avec mes enfants.`
		],
	...
	} , 
	{
		...
		impactIntro: `Mon statut d'immigration est <strong>précaire car ...</strong>`,
		impacts: [
			`J’ai peur de faire valoir mes droits et de dénoncer une situation d’exploitation de la part de mon employeur <strong>par crainte de perdre mon emploi et, par conséquent, mon statut d’immigration</strong>.`,
			`On ne me permet pas de changer de travail ni d'employeur.`,
			`Après un an et demi de travail, je n'ai pas pu encore prendre de vacances, et j'hésite à insister de <strong>peur que cela nuise à la possibilité de renouveler mon permis</strong>.`,
			`<strong>Je n’ai jamais été payé pour les heures supplémentaires</strong>, même si je fais plus de 75 heures par semaine et que je suis payé pour 35 heures.`
		],
