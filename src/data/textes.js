export default function lesTextes() { return {
	rever: {
		fr: {
			...
			p6a2: "Une personne im·migrante ou réfugiée aura accès à 10 heures d'assistance juridique et de soutien social essentiel gratuit.",
			p6a3: "Une personne im·migrante en situation de vulnérabilité aura accès gratuitement à 30 heures de travail, comprenant la recherche, la rédaction, la soumission et le suivi auprès des autorités concernant une demande humanitaire de résidence permanente.",
			b6a: "Donner",
		...
		en: {
			...
			p6a2: "An immigrant or refugee can receive 10 hours of legal assistance and social support, free of charge.",
			p6a3: "An immigrant in a vulnerable situation can receive 30 hours of free legal work, including research, drafting, submission, and follow-up with the authorities for a humanitarian permanent residency application.",
